...
hi ColorColumn guifg=NONE ctermfg=NONE guibg=#2a1a3b ctermbg=234 gui=NONE cterm=NONE
hi Cursor guifg=NONE ctermfg=NONE guibg=#FAD000 ctermbg=220 gui=NONE cterm=NONE
hi CursorColumn guifg=NONE ctermfg=NONE guibg=#2a1a3b ctermbg=234 gui=NONE cterm=NONE
hi CursorLine guifg=NONE ctermfg=NONE guibg=#2a1a3b ctermbg=234 gui=NONE cterm=NONE
...
hi DiffText guifg=#FEE9F0 ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Folded guifg=#A599E9 ctermfg=140 guibg=#2a1a3b ctermbg=234 gui=NONE cterm=NONE
...
hi CursorLineNr guifg=#FEE9F0 ctermfg=195 guibg=#28284E ctermbg=235 gui=NONE cterm=NONE
hi MatchParen guifg=#32274C ctermfg=236 guibg=#FAEFA5 ctermbg=229 gui=NONE cterm=NONE
hi NonText guifg=#A599E9 ctermfg=140 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Normal guifg=#FEE9F0 ctermfg=195 guibg=#32274C ctermbg=236 gui=NONE cterm=NONE
hi PMenu guifg=#A599E9 ctermfg=140 guibg=#1F1F41 ctermbg=235 gui=NONE cterm=NONE
hi PMenuSel guifg=#9EFFFF ctermfg=159 guibg=#32274C ctermbg=236 gui=NONE cterm=NONE
hi Search guifg=NONE ctermfg=NONE guibg=#7d44b2 ctermbg=97 gui=NONE cterm=NONE
hi IncSearch guifg=#2a1a3b ctermfg=234 guibg=#FFFE4C ctermbg=11 gui=NONE cterm=NONE
hi SpellBad guifg=#FF628C ctermfg=204 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi StatusLine guifg=#A599E9 ctermfg=140 guibg=#32274C ctermbg=236 gui=NONE cterm=NONE
hi StatusLineNC guifg=#A599E9 ctermfg=140 guibg=#2a1a3b ctermbg=234 gui=NONE cterm=NONE
...
hi TabLineSel guifg=#2a1a3b ctermfg=234 guibg=#A599E9 ctermbg=140 gui=NONE cterm=NONE
...
hi WildMenu guifg=NONE ctermfg=NONE guibg=#2a1a3b ctermbg=234 gui=NONE cterm=NONE
...
hi jsClassProperty guifg=#FEE9F0 ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi jsFlowObject guifg=#FEE9F0 ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi jsFuncArgs guifg=#FEE9F0 ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi javaScriptRegexpString guifg=#FEE9F0 ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi tsxTag guifg=#FEE9F0 ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi tsxCloseTag guifg=#FEE9F0 ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
